      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          Eigen::Map<Eigen::VectorXd> ptsx_tf(ptrx, 6);
          Eigen::Map<Eigen::VectorXd> ptsy_tf(ptry, 6);

          // polyfit to the points
          ...
          for (int i = 1; i < n_points; i++) {
              ...
              next_y_vals.push_back(polyeval(coeffs, delta*i));
          }
          ...
          // extract the mpc x and v values
